...
# They also record host runtime and transitive dependency versions. Normalize
# that environment metadata so pinned generator versions produce stable files.
sed -i -E \
  's#<!-- generated by https://github.com/cabo/kramdown-rfc version 1\.7\.43 \(Ruby [^)]+\) -->#<!-- Generated with kramdown-rfc 1.7.43. -->#' \
  "$draft_name.xml"
sed -i \
  '/<!-- Generator version information:/,/^-->/c\<!-- Generated with xml2rfc 3.34.0. -->' \
  "$draft_name.html"
